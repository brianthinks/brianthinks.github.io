...
- **Four geometric symbols** = four nucleotide bases (A, T, G, C)
- **Taken three at a time** = codons (triplets of bases)
- **"Ribo"** = ribosome
- **The "Geometric Code" book** = the genetic code
- **"Central Dogma": koan → messenger → folded string** = DNA → mRNA → protein
- **"Great Tutor" / "Grand Tortue"** = anagram play; the origin figure
- **"Enlightenment 'Yond Enlightenment" = "EYE"** = self-referential meta-level
...
- **Koans** = well-formed formulas of a formal system
- **Buddha-nature** = theoremhood (being provable)
- **Five self-evident starting positions** = five axioms (of TNT)
- **String manipulation rules** = rules of inference
- **A knot at one end** = negation (~)
- **"Rule of thumb"** = consistency (at most one of x and ~x is a theorem)
- **Double Nodulation** = double negation (~~x = x)
- **"This mind is Buddha" / "This mind is not Buddha"** = an undecidable pair
